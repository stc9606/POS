...
<body onLoad="loadInit('member')" onUnload="logOut()">
	<div id="canvas">
		...
		<div id="menu">
			<div id="command">
				...
				<button id="member" class="action">회원관리</button>
				...
				<button id="sales" class="action" onClick="moveSalesMgr()" onMouseOver="changeButton(this, 1, 'actionOver')" onMouseOut="changeButton(this, 0, 'action')">판매관리</button>
			</div>
		</div>
	</div>
